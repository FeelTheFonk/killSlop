...
Write-Host "   killSlop v0.0.2 // PREPARATION" -ForegroundColor Cyan
Write-Host "======================================================================" -ForegroundColor Cyan
Write-Host ""
...
try {
    Checkpoint-Computer -Description "Checkpoint_killSlop_v0.0.2" -RestorePointType "MODIFY_SETTINGS"
